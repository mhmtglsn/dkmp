...
## [1.0.0] — 2026-07
İlk resmî sürüm. (Geliştirme sayacındaki v94 ile aynı yapıdır; bundan sonra
anlamlı sürümleme kullanılır: hata düzeltme → 1.0.1, yeni özellik → 1.1.0,
kırıcı değişiklik → 2.0.0.)
### Eklendi
